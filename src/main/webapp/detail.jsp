...
Products p = (Products) em.find(Products.class, 1);
%>
<head>
<meta charset="utf-8">
				...
				<nav
					...
					<div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
						<div class="nav-item dropdown">
							...
							<a href="" class="nav-item nav-link"><%=p.getCategory()%></a>
	...
	<div class="container-fluid py-5">
		<div class="row px-xl-5">
					...
					<div class="carousel-inner border">
						<div class="carousel-item active">
							<img class="w-100 h-100"
								src="upload_image/<%=p.getImages().getImage1()%>" alt="Image">
						</div>
						<div class="carousel-item">
							<img class="w-100 h-100"
								src="upload_image/<%=p.getImages().getImage2()%>" alt="Image">
						</div>
						<div class="carousel-item">
							<img class="w-100 h-100"
								src="upload_image/<%=p.getImages().getImage3()%>" alt="Image">
						</div>
						<div class="carousel-item">
							<img class="w-100 h-100"
								src="upload_image/<%=p.getImages().getImage4()%>" alt="Image">
						</div>
					</div>
			...
			<div class="col-lg-7 pb-5">
				...
				<h3 class="font-weight-semi-bold mb-4"><%=p.getP_price()%></h3>
				<p class="mb-4"><%=p.getInfo()%></p>
				<div class="d-flex mb-3">
					...
					<form>
						...
						<div class="custom-control custom-radio custom-control-inline">
							<input type="radio" class="custom-control-input" id="size-5"
								...
								for="size-5"><%=p.getSize().getSize1()%></label>
						</div>
						<div class="custom-control custom-radio custom-control-inline">
							<input type="radio" class="custom-control-input" id="size-5"
								name="size"> <label class="custom-control-label"
								for="size-5"><%=p.getSize().getSize2()%></label>
						</div>
						<div class="custom-control custom-radio custom-control-inline">
							<input type="radio" class="custom-control-input" id="size-5"
								name="size"> <label class="custom-control-label"
								for="size-5"><%=p.getSize().getSize3()%></label>
						</div>
						<div class="custom-control custom-radio custom-control-inline">
							<input type="radio" class="custom-control-input" id="size-5"
								name="size"> <label class="custom-control-label"
								for="size-5"><%=p.getSize().getSize4()%></label>
						</div>
					...
					<form>
						<div class="custom-control custom-radio custom-control-inline">
							<input type="radio" class="custom-control-input" id="color-1"
								...
								for="color-1"><%=p.getColor().getColor1()%></label>
						</div>
						<div class="custom-control custom-radio custom-control-inline">
							<input type="radio" class="custom-control-input" id="color-1"
								name="color"> <label class="custom-control-label"
								for="color-1"><%=p.getColor().getColor2()%></label>
						</div>
						<div class="custom-control custom-radio custom-control-inline">
							<input type="radio" class="custom-control-input" id="color-1"
								name="color"> <label class="custom-control-label"
								for="color-1"><%=p.getColor().getColor3()%></label>
						</div>
						<div class="custom-control custom-radio custom-control-inline">
							<input type="radio" class="custom-control-input" id="color-1"
								name="color"> <label class="custom-control-label"
								for="color-1"><%=p.getColor().getColor4()%></label>
						</div>
			...
			<div class="col">
				...
				<div class="tab-content">
					...
					<div class="tab-pane fade" id="tab-pane-3">
						<div class="row">
							<%
							int size_review = p.getpReview().size();
							%>
							<%
							for (int i = 0; i < size_review; i++) {
							%>
							<div class="col-md-6">
								<h4 class="mb-4"><%=size_review%>
									review for
									<%=p.getP_name()%></h4>
								<div class="media mb-4">
									<img src="<%=p.getpReview().get(0).getRimage()%>" alt="Image"
										class="" style="width: 45px;">
									<div class="media-body">
										<h6><%=p.getpReview().get(0).getRname()%><small>
												- <i><%=p.getpReview().get(0).getDate()%></i>
											</small>
										</h6>
										...
										<p><%=p.getpReview().get(0).getReview()%></p>
									</div>
								</div>
							</div>
							<%
