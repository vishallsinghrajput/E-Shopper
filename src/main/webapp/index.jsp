...
<%@page import="com.ducat.model.PReview"%>
<%@page import="com.ducat.model.PImages"%>
...
<body>
	...
	<div class="container-fluid pt-5">
		<div class="row px-xl-5 pb-3">
			...
			<%
			for (Products data0 : data) {
			%>
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					style="padding: 30px;">
					<p class="text-right"><%=data0.getP_quantity()%></p>
					<a href="" class="cat-img position-relative overflow-hidden mb-3">
						<img class="img-fluid" height="200px" width="150px"
						src="upload_image/<%=data0.getImages().getImage1()%>" alt="">
					</a>
					<h5 class="font-weight-semi-bold m-0"><%=data0.getP_price()%></h5>
				</div>
			</div>
			<%
			}
